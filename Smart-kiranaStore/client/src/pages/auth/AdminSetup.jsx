          ...
          <div className="hidden bg-gradient-to-br from-black via-gray-900 to-gray-800 p-10 text-white xl:flex xl:flex-col xl:justify-between">
            <div>
              ...
              <h1 className="mt-8 text-5xl font-extrabold tracking-tight">
                Create your
                <span className="block text-white/70">admin account</span>
              </h1>

              <p className="mt-5 max-w-md text-sm leading-7 text-white/75">
                Smart Kirana start karne ke liye pehle admin account create karo.
              </p>
            </div>
          ...
          <div className="p-6 md:p-8 xl:p-10">
            <div className="mx-auto max-w-md">
              ...
              <p className="mt-3 text-sm leading-7 text-gray-500">
                Admin account create karke Smart Kirana use karna start karo.
              </p>
